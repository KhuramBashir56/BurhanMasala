...
<div x-data="{ showAlert: true, type: '{{ $type }}', message: '{{ $message }}' }" x-show="showAlert" class="flex gap-x-2 items-center border-s-[16px]  p-4 relative rounded-lg shadow-lg" x-cloak :class="{
