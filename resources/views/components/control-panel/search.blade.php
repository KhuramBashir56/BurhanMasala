...
<div {{ $attributes->merge(['class' => 'w-full relative']) }}>
    <x-control-panel.form.input type="search" wire:model.live.debounce.1000ms="searchQuery" wire:keydown.enter="search" for="searchQuery" maxlength="64" autocomplete="off" placeholder="{{ $title }}" class="pe-14" />
