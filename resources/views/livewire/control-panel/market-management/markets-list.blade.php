<div class="w-full space-y-4" x-data="">
    ...
    <x-control-panel.table>
        <x-control-panel.table.thead>
            <x-control-panel.table.th content="Markets" />
        ...
        <x-control-panel.table.tbody>
            @forelse ($markets as $market)
                <x-control-panel.table.tr wire:key="city-{{ $market->id }}">
                    <x-control-panel.table.td>
                        <p class="text-lg font-semibold capitalize whitespace-nowrap">{{ $market->name }}</p>
